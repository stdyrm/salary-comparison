    ...
    const createScales = async () => {
      ...
      const getColorScale = (occupation, value) => {
        const colorScale = scaleSequential(interpolateRdYlGn).domain(
          statesPerOccupation[occupation]
        );
      ...
      const yAxis = select(yRef.current)
        .call(yAxisGenerator)
        .selectAll("text")
        .attr("class", classes.axis)
              ...
              <>
                ...
                <Labels
                  ...
                  innerProps={{
                    ...
                    xLabel: {
                      textAnchor: "start",
                      transform: `translate(${width + margin.right * 0.25}, ${
                        height + 10
                      })`,
                    },
                    yLabel: {
                      textAnchor: "end",
                      transform: `translate(0, ${-margin.top * 0.25})`,
                    },
                  }}
                  labels={{
                    yLabel: "Occupation",
