      ...
      <Toolbar className={classes.toolbar} disableGutters>
        ...
        <Hidden smDown>
          <nav className={classes.navLinkContainer}>
            <Button
              href="/salary-comparison/#/rpi-app"
              className={classes.navButtons}
            >
              Real Income
            </Button>
            <Button
              href="/salary-comparison/#/bls-app"
              className={classes.navButtons}
            >
              Salary Comparison
            </Button>
            <Button href="/salary-comparison/#" className={classes.navButtons}>
              Home
            </Button>
          </nav>
        </Hidden>
          ...
          <Paper>
            <ClickAwayListener onClickAway={handleNavMenu}>
              <MenuList className={classes.navLinkMenu}>
                <MenuItem component={Link} to="/rpi-app">
                  Real Income
                </MenuItem>
                <MenuItem component={Link} to="/bls-app">
                  Salary Comparison
                </MenuItem>
